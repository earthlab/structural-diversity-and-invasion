...
a. Downloads all plant cover data and plot specific data for all date-site combinations using [NEON API](https://data.neonscience.org/data-products/explore). The files are in compressed .rar format. We selected only forest NEON sites for further processing in this study. 
